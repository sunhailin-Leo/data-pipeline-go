...
const (
	...
	ConfigFromHTTPTagName      string = "http"
	...
	ConfigFromHTTPEnvHosts                 string = "HTTP_HOSTS"                   // If CONFIG_SRC = http, then required
	ConfigFromHTTPEnvConfigURI             string = "HTTP_CONFIG_URI"              // If CONFIG_SRC = http, then required
	ConfigFromHTTPEnvHeartBeatURI          string = "HTTP_HEARTBEAT_URI"           // optional
	ConfigFromHTTPEnvHeartBeatIntervalSecs string = "HTTP_HEARTBEAT_INTERVAL_SECS" // optional
